...
def fisher_matrix_diag(t,dataloader,device, model,num_classes = 10):
    # Init
    fisher = {}
...
class Appr(object):
    ...
    def train(self, t):
        ...
        self.fisher = fisher_matrix_diag(t,self.tr_dataloader, self.device,self.model,num_classes=self.num_classes)
        if t > 0:
