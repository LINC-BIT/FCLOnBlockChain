...
from LongLifeMethod.NperEWC import Appr,LongLifeTest,LongLifeTrain
...
if __name__ == '__main__':
    ...
    print(args.alg)
    write = SummaryWriter('./log/NperEwc_' + args.dataset+'_'+'round' + str(args.round) + '_frac' + str(args.frac))
    # build model
    ...
    for iter in range(args.epochs):
        ...
        if iter % args.round == args.round-1:
            ...
            model_save_path = './save/accs_NperEWC_lambda_'+str(args.lamb) +str('_') + args.alg + '_' + args.dataset + '_' + str(args.num_users) + '_' + str(
    ...
    print(times)
    print(accs)
    base_dir = './save/accs_NperEWC_lambda_'+str(args.lamb) +str('_') + args.alg + '_' + args.dataset + '_' + str(args.num_users) + '_' + str(
