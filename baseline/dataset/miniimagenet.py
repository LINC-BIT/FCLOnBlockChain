...
#     m = MiniImageTask(root='../data/mini-imagenet',json_path="../data/mini-imagenet/classes_name.json",task_num=10)
#     t,_ =m.getTaskDataSet()
#     for i in t:
#         a =i[0]
    ...
    # net_glob = RepTail([3, 224, 224])
    # net_glob.cuda()
    # net_glob.train()
    # opt = torch.optim.SGD(net_glob.parameters(), 0.1)
