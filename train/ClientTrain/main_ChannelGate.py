...
from ClientTrain.LongLifeMethod.ChannelGate import Appr,LongLifeTrain
...
if __name__ == '__main__':
    ...
    print(args.alg)
    write = SummaryWriter('./log/ChannelGate/ChannelGate_high20_dag_' + args.dataset+'_'+'round' + str(args.round) + '_frac' + str(args.frac))
    # build model
    ...
    print(args.round)
    serverAgg = FedDag(int(args.frac * args.num_users),int(args.frac * args.num_users * 5),datasize=[3,32,32],dataname='CIFAR100',output=10)
    w_globals = []
    ...
    print(times)
    print(accs)
    # base_dir = './save/Packnet/0.4_dag_High10_ccs_Packnet_lambda_'+str(args.lamb) +str('_') + args.alg + '_' + args.dataset + '_' + str(args.num_users) + '_' + str(
