...
def densenet121_body(pretrained=False, progress=True, **kwargs):
...
class Densenet121(nn.Module):
    def __init__(self, inputsize, outputsize=100,nc_per_task = 10):
        ...
        self.feature_net = densenet121_body()
        num_features = self.feature_net.num_features
        # Linear layer
        self.last = nn.Linear(num_features, outputsize)
