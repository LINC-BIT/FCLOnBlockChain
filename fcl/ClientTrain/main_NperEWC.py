...
from ClientTrain.LongLifeMethod.NperEWC import Appr,LongLifeTest,LongLifeTrain
...
if __name__ == '__main__':
    ...
    print(times)
    print(accs)
    base_dir = './save/Nperewc/0.4_dag_High10_ccs_Fedavg_lambda_'+str(args.lamb) +str('_') + args.alg + '_' + args.dataset + '_' + str(args.num_users) + '_' + str(
