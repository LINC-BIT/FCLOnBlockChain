...
def get_data(args):
    if args.dataset == 'mnist':
        ...
        dict_users_train, rand_set_all = noniid(dataset_train, args.num_users, args.shard_per_user, args.num_classes, 'cifar10')
        dict_users_test, rand_set_all = noniid(dataset_test, args.num_users, args.shard_per_user, args.num_classes, rand_set_all=rand_set_all, dataname='cifar10')
    elif args.dataset == 'cifar100':
        # TODO 运行代码前要修改文件存储位置
        cifar100 = Cifar100Task('/data/lpyx/FedAgg/data/cifar100',task_num=10)
        ...
        Miniimagenet = MiniImageTask(root='C:/Users/keqiu/Desktop/zt/FedRep-main/data/mini-imagenet/',json_path="C:/Users/keqiu/Desktop/zt/FedRep-main/data/mini-imagenet/classes_name.json",task_num=10)
