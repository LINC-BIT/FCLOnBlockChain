...
def args_parser():
    ...
    parser.add_argument('--clmethod', type=str, default='',required=True, help="method of continual learning")
    ...
    parser.add_argument('--lamb', default=20000, type=float, help='(default=%(default)f)')
