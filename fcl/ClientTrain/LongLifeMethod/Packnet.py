...
class Appr(object):
    ...
    def __init__(self, model, tr_dataloader, nepochs=100, lr=0.001, lr_min=1e-6, lr_factor=3, lr_patience=5,
                 clipgrad=100,args=None, kd_model=None, kd_epoch=0):
    ...
    def train(self, t):
        ...
        for e in range(self.nepochs):
            ...
            self.train_packnet(t,kd_lambda=kd_lambda)
    ...
    def train_packnet(self,t,kd_lambda = 0.0):
        ...
        for images, targets in self.tr_dataloader:
            ...
            loss = self.ce(outputs, targets) + kd_lambda*MultiClassCrossEntropy(outputs,kd_outpus,t,T=2)
    ...
    def train_kd(self,t):
        self.cur_kd.cuda()
        self.cur_kd.train()
        kd_optimizer = torch.optim.Adam(self.cur_kd.parameters(), lr=0.0008)
