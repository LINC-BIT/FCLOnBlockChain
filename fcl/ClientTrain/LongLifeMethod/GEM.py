...
class Appr():
    ...
    def observe(self, x, t, y,kd_lambda = 0):
        ...
        loss = self.ce(cur_output, y - offset1) + kd_lambda * MultiClassCrossEntropy(cur_output,kd_output,t,T=2)
...
def life_experience(task,appr:Appr,tr_dataloader,epochs,sbatch=10,args=None):
