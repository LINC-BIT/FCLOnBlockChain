...
from ClientTrain.LongLifeMethod.GEM import Appr,LongLifeTest,LongLifeTrain
...
if __name__ == '__main__':
    ...
    print(args.alg)
    write = SummaryWriter('/data/lpyx/FedAgg/ClientTrain/log/GEM/GEM_high' + args.dataset+'_'+'round' + str(args.round) + '_frac' + str(args.frac))
    # build model
    ...
    # training
    serverAgg = FedDag(int(args.frac * args.num_users), int(args.frac * args.num_users * 5), datasize=[3, 32, 32],
                       dataname='CIFAR100')
    ...
    # print(times)
    # print(accs)
    # base_dir = './save/GEMaccs_GEM_lambda_'+str(args.lamb) +str('_') + args.alg + '_' + args.dataset + '_' + str(args.num_users) + '_' + str(
